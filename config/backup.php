...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Hanya backup folder penting, tidak semua base_path
                    base_path('app'),
                    base_path('config'),
                    base_path('database'),
                    base_path('public'),
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'k4grafika-cafe-',
            ...
            'disks' => [
                'local',
                // Tambahkan 's3' atau 'google' jika ingin backup ke cloud
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             * Simpan backup harian untuk 30 hari
             */
             ...
             * Simpan backup mingguan untuk 12 minggu (3 bulan)
             */
             ...
             * Simpan backup bulanan untuk 6 bulan
             */
             ...
             * Maksimal 2GB untuk semua backup
             */

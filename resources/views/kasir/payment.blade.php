...
@section('content')
  <style>
    ...
    .nota-separator {
      border: none;
      border-top: 1px dashed #A74C29;
      /* langsung kasih warna di border-top */
      margin: 10px 0;
    }
    ...
    .payment-method {
      ...
      flex-direction: column;
      justify-content: space-between;
      /* biar tombol confirm tetap di bawah */
    }
    ...
    <div class="grid">
      ...
      <div class="card" style="margin-bottom: 0;">
        ...
        <div class="payment-tabs">
          <button type="button" id="tab-cash" class="btn btn-secondary tab-btn active" onclick="showCash()">Cash</button>
          <button type="button" id="tab-qris" class="btn btn-secondary tab-btn" onclick="showQris()">QRIS</button>
        </div>
        ...
        <div id="cash-method" class="payment-method show">
          <div class="payment-body">
            ...
            <div class="grid-buttons">
              @foreach(['1', '2', '3', '4', '5', '6', '7', '8', '9', '00', '0', 'C'] as $b)
                <button type="button" class="btn {{ $b === 'C' ? 'btn-clear' : 'btn-light' }}"
          ...
          <form id="confirm-cash-form" action="{{ route('kasir.payment.process') }}" method="POST">
            ...
            <button type="button" onclick="validateCash()" class="btn btn-primary w-100 mt-3" style="margin-top: 20px;">
